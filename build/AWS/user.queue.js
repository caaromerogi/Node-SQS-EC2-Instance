...
var client = new client_sqs_1.SQS(sqsConfig);
var sender = function (param) { return __awaiter(void 0, void 0, void 0, function () {
    var params;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                console.log(params);
                return [4 /*yield*/, client.send(new client_sqs_1.SendMessageCommand(params))];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
